...
from app.api.route_registry import RouteDeclarationRegistry
...
route_declarations = RouteDeclarationRegistry()
router = route_declarations.for_domain("core")
...
@router.get("/integrations/yandex/direct/status")
def yandex_direct_status() -> dict:
    settings = get_settings()
    return check_yandex_direct(settings)


@router.post("/utm/generate", response_model=UtmGenerateResult)
...
@router.post("/simulations/budget", response_model=BudgetSimulationResult)
...
@router.get("/audit/campaigns", response_model=CampaignAuditResult)
...
@router.patch("/campaign-drafts/{draft_id}", response_model=CampaignDraft)
...
@router.patch("/campaign-drafts/{draft_id}/keywords", response_model=CampaignDraft)
...
@router.post("/campaign-drafts/{draft_id}/keywords", response_model=CampaignDraft)
...
@router.delete("/campaign-drafts/{draft_id}/keywords", response_model=CampaignDraft)
...
@router.post("/campaign-drafts/{draft_id}/ad-groups", response_model=CampaignDraft)
...
@router.post("/campaign-drafts/{draft_id}/ads", response_model=CampaignDraft)
...
@router.patch("/campaign-drafts/{draft_id}/ads/{ad_id}", response_model=CampaignDraft)
...
@router.delete("/campaign-drafts/{draft_id}/ads/{ad_id}", response_model=CampaignDraft)
...
@router.post("/campaign-drafts/{draft_id}/validate", response_model=ValidationResult)
...
@router.get("/campaign-drafts/{draft_id}/preview", response_model=PreviewPayload)
...
@router.patch("/campaign-drafts/{draft_id}/budget", response_model=CampaignDraft)
...
@router.patch("/campaign-drafts/{draft_id}/bids", response_model=CampaignDraft)
...
@router.post("/recommendations/{recommendation_id}/approve", response_model=ApprovalResult)
...
@router.post("/recommendations/{recommendation_id}/reject", response_model=ApprovalResult)
...
@router.post("/actions/{action_id}/apply", response_model=ApplyActionResult)
...
@router.get("/audit-log", response_model=AuditLog)
def audit_log() -> AuditLog:
    return AuditLog(items=store.audit_events)


router = route_declarations.for_domain("direct")
...
@router.get("/yandex/campaigns", response_model=YandexCampaignList)
...
@router.get("/yandex/campaigns/{campaign_id}/ads", response_model=YandexAdList)
def yandex_ads(
    campaign_id: str,
    settings: Settings = Depends(get_settings),
    client: YandexDirectClient | None = Depends(get_yandex_client),
...
@router.get("/yandex/changes/check", response_model=YandexRawResult)
...
@router.get("/yandex/changes", response_model=YandexRawResult)
...
@router.get("/yandex/dictionaries", response_model=YandexRawResult)
...
@router.get("/yandex/campaigns/{campaign_id}/bid-modifiers", response_model=YandexBidModifiersReadResult)
...
@router.get("/yandex/campaigns/{campaign_id}/negative-keywords", response_model=YandexRawResult)
...
@router.get("/yandex/retargeting-lists", response_model=YandexRawResult)
...
@router.get("/yandex/campaigns/{campaign_id}/audience-targets", response_model=YandexRawResult)
...
@router.get("/yandex/sitelinks", response_model=YandexRawResult)
...
@router.get("/yandex/vcards", response_model=YandexRawResult)
def yandex_vcards(
    settings: Settings = Depends(get_settings),
    client: YandexDirectClient | None = Depends(get_yandex_client),
) -> YandexRawResult:
...
@router.post("/yandex/vcards", response_model=YandexVCardResult)
...
@router.post("/yandex/ads/business", response_model=YandexAdsBusinessAttachResult)
...
@router.post("/yandex/ads/moderate", response_model=AdsModerateResult)
...
@router.get("/yandex/ad-images", response_model=YandexRawResult)
...
@router.get("/yandex/creatives", response_model=YandexRawResult)
...
@router.get("/yandex/feeds", response_model=YandexRawResult)
def yandex_feeds(
    settings: Settings = Depends(get_settings),
    client: YandexDirectClient | None = Depends(get_yandex_client),
) -> YandexRawResult:
...
@router.get("/yandex/businesses", response_model=YandexRawResult)
...
@router.get("/yandex/agency-clients", response_model=YandexRawResult)
...
@router.get("/yandex/keywords-research/has-search-volume", response_model=YandexRawResult)
...
@router.get("/yandex/keywords-research/deduplicate", response_model=YandexRawResult)
...
@router.get("/yandex/reports/live/{report_type}", response_model=YandexRawResult)
def yandex_report(
    report_type: str,
    date_from: str,
    date_to: str,
...
@router.get("/yandex/reports/search-queries-live", response_model=YandexRawResult)
...
router = route_declarations.for_domain("wordstat")
...
router = route_declarations.for_domain("direct_extensions")
...
router = route_declarations.for_domain("metrika")
